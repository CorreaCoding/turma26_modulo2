...
public class CategoriaController {
	...
	// Listar Categorias por ID - Método 03 - Expressão Lambda
		...
		// Listar todas as Categorias por descrição
		@GetMapping("/tipo/{tipo}")
		public ResponseEntity<List<Categoria>> getByDescricao(@PathVariable String descricao) {
			return ResponseEntity.ok(categoriaRepository.findAllByDescricaoContainingIgnoreCase(descricao)); // Mostra lista de postagens estando vazia ou não
		}
